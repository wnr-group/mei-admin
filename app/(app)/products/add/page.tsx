...
import { addProduct } from '@/lib/mockDb';
import { Image as ImageIcon, Upload, X, ChevronDown, ChevronUp, Loader2, Plus } from 'lucide-react';
...
export default function AddProductPage() {
  ...
  const [selectedWorkTypes, setSelectedWorkTypes] = useState<string[]>(['Zardozi']); // "Zardozi" selected by default as in screenshot
  ...
  const [published, setPublished] = useState(false); // Unchecked by default in screenshot
  const [featured, setFeatured] = useState(false); // Unchecked by default
  const [newArrival, setNewArrival] = useState(true); // Checked by default in screenshot
  ...
  return (
    <div className="max-w-[1200px] mx-auto space-y-6 pb-16 font-inter animate-fade-in">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex items-center justify-between pt-4">
              <Link
                href="/products"
                className="text-[11px] font-bold tracking-widest text-zinc-500 hover:text-zinc-800 transition-colors uppercase py-2 cursor-pointer"
              >
                Cancel
              </Link>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-[#E8E0D5] p-8 space-y-6">
              ...
              <div
                ...
                className={`border border-dashed p-8 text-center cursor-pointer transition-colors duration-200 flex flex-col items-center justify-center min-h-[160px] ${
                  isDragging
                ...
                {images.map((img, idx) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="absolute right-0.5 top-0.5 bg-black/60 hover:bg-black text-white rounded-full p-0.5 transition-colors"
                    >
              ...
              <div className="space-y-4">
                ...
                <label className="flex items-center gap-3 cursor-pointer group">
                  <input
                    ...
                    className="w-4 h-4 border border-[#E8E0D5] text-[#B38B5D] focus:ring-[#B38B5D] rounded-none cursor-pointer accent-[#B38B5D]"
                  />
