...
export type Database = {
  public: {
    Tables: {
      ...
      products: {
        Row: { id: string; name: string; slug: string; category_id: string | null; price: number; compare_at_price: number | null; short_description: string | null; description: string | null; status: 'PUBLISHED' | 'DRAFT'; featured: boolean; new_arrival: boolean; work_types: string[]; color_variants: Json; available_sizes: string[]; custom_size_enabled: boolean; blouse_options_enabled: boolean; blouse_types: string[]; meta_title: string | null; meta_description: string | null; meta_keywords: string | null; image_url: string | null; created_at: string; updated_at: string; deleted_at: string | null }
        Insert: { id?: string; name: string; slug: string; category_id?: string | null; price: number; compare_at_price?: number | null; short_description?: string | null; description?: string | null; status?: 'PUBLISHED' | 'DRAFT'; featured?: boolean; new_arrival?: boolean; work_types?: string[]; color_variants?: Json; available_sizes?: string[]; custom_size_enabled?: boolean; blouse_options_enabled?: boolean; blouse_types?: string[]; meta_title?: string | null; meta_description?: string | null; meta_keywords?: string | null; image_url?: string | null }
        Update: { name?: string; slug?: string; category_id?: string | null; price?: number; compare_at_price?: number | null; short_description?: string | null; description?: string | null; status?: 'PUBLISHED' | 'DRAFT'; featured?: boolean; new_arrival?: boolean; work_types?: string[]; color_variants?: Json; available_sizes?: string[]; custom_size_enabled?: boolean; blouse_options_enabled?: boolean; blouse_types?: string[]; meta_title?: string | null; meta_description?: string | null; meta_keywords?: string | null; image_url?: string | null; deleted_at?: string | null }
      }
      customers: {
